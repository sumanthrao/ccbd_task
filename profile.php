...
<script>
    function func(value,id){
        alert("friend Request has been sent to "+value);
        var d= document.getElementById(id).name="Request Sent";
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="#" style="font-size:150%;height:100px;padding:30px;" >About</a>
                    </li>
                    <li>
...
while ($cursor1->hasNext()):
                         ...
                         echo "<button class='btn' type='submit' method=get name='Follow' onclick='func(this.value,this.id)' id=$user_name value=$user_name> Send Friend Request </button>";
                         echo "</a>";
     echo "</div>";                    
   ...
   while($object = $cursor->hasNext()): 
    ...
    <?php endwhile;
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright sumanthrao_designs</p>
                </div>
            </div>
        </footer>
